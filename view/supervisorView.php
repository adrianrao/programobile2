      ...
      <div class="card black darken-1">
        ...
        <div class="card-action">
          <form action="/supervisor/eliminarCliente" method="post">
            <input type="hidden" value="{{id_cliente}}" name="id_cliente">
            <button class="btn waves-effect waves-light orange darken-2" type="submit" name="action">Eliminar<i
            ...
            <div class="card-content">
              ...
              <div class="form-field">
                <div class="form-field">
                  ...
                  <input type="text" id="denominacion" name="denominacion" class="white-text" value="{{denominacion}}"
                    required>
                </div>
                <br>
                ...
                <div class="form-field">
                  ...
                  <input type="text" id="direccion_cp" name="direccion_cp" class="white-text" value="{{direccion_cp}}"
                    required>
                </div>
                <br>
          ...
          <div class="card black darken-1">
            ...
            <div class="card-action">
              <form action="/supervisor/mostrarDetalleDeTractor" method="post">
                ...
                <button class="btn waves-effect waves-light blue darken-2" type="submit" name="action">Ver detalle<i
                    class="material-icons right">send</i></button>
              </form>
            </div>
          </div>
            ...
            <div class="card-content white-text">
              <ul class="collection with-header">
                ...
                <li class="collection-item"><strong class="orange-text text-lighten-2">Año de
                    fabricacion:</strong> {{año_fabricacion}}</li>
                <li class="collection-item"><strong class="orange-text text-lighten-2">Numero de
                    motor:</strong> {{nro_motor}}</li>
                <li class="collection-item"><strong class="orange-text text-lighten-2">Numero de
                    chasis:</strong> {{nro_chasis}}</li>
                <li class="collection-item"><strong class="orange-text text-lighten-2">Kilometraje:</strong>
                  {{kilometraje}}</li>
              </ul>
            </div>
          </div>
              ...
              <div class="card black darken-1">
                ...
                <div class="card-action">
                  <form action="/supervisor/eliminarTractor" method="post">
                    <input type="hidden" value="{{id_tractor}}" name="id_tractor">
                    <button class="btn waves-effect waves-light blue darken-2" type="submit" name="action">Eliminar<i
                        class="material-icons right">send</i></button>
                  </form>
                </div>
              </div>
              ...
              <div class="card black darken-1">
                ...
                <div class="card-action">
                  <form action="/supervisor/mostrarDatosDelTractorConcretoAModificar" method="post">
                    <input type="hidden" value="{{id_tractor}}" name="id_tractor">
                    <button class="btn waves-effect waves-light blue darken-2" type="submit" name="action">Modificar<i
                        class="material-icons right">send</i></button>
                  </form>
                </div>
              </div>
                  ...
                  <form method="POST" action="/supervisor/modificarTractorConcreto">
                    <div class="card-content">
                      ...
                      <div class="form-field">
                        <div class="form-field">
                          <label for="marca">Marca:</label>
                          <input type="text" id="marca" name="marca" class="white-text" value="{{marca}}" required>
                        </div>
                        <br>

                        <div class="form-field">
                          <label for="modelo">Modelo:</label>
                          <input type="text" id="modelo" name="modelo" class="white-text" value="{{modelo}}" required>
                        </div>
                        <br>
                        ...
                        <div class="form-field">
                          <label for="nroMotor">Numero de motor:</label>
                          <input type="text" id="nroMotor" name="nroMotor" class="white-text" value="{{nro_motor}}"
                            required>
                        </div>
                        <br>
                        ...
                        <div class="form-field">
                          <label for="nroChasis">Numero de chasis:</label>
                          <input type="text" id="nroChasis" name="nroChasis" class="white-text" value="{{nro_chasis}}"
                            required>
                        </div>
                        <br>
                        ...
                        <div class="form-field">
                          <label for="patente">Patente:</label>
                          <input type="text" id="patente" name="patente" class="white-text" value="{{patente}}"
                            required>
                        </div>
                        <br>
                        ...
                        <div class="form-field">
                          <label for="kilometraje">Kilometraje:</label>
                          <input type="number" id="kilometraje" name="kilometraje" class="white-text"
                      ...
                      <div class="card-action">
                        ...
                        <button class="btn waves-effect waves-light blue darken-2" type="submit" name="action">Modificar
                          Tractor
                          <i class="material-icons right">send</i>
                  </form>
                  </button>
      ...
      <div class="row">
        <div class="col s12 m12">
          <div class="card black darken-1">
            ...
            <div class="card-action">
              <form action="/proforma/mostrardetalleproforma" method="post">
  ...
  <div class="col s12 m6 offset-m3">
    <div class="card">
      ...
      <form >
        <div class="card-action form-field">
          <label for="fecha">Fecha:</label>
          <input type="text" id="fecha" name="fecha" class="white-text" />
          <br />
          <br />
          <h5>Cliente</h5>
          <br />
          <label for="denominacion">Denominacion:</label>
          <input type="text" class="white-text" value="{{viaje_denominacion}}">
          <br />
          <label for="cuit">Cuit:</label>
          ...
          <br />
          <label for="ETD">ETD:</label>
          <input type="date" id="ETD" name="ETD" class="white-text" value="{{viaje_ETD}}"/>
          <br />
          <label for="ETA">ETA:</label>
          <input type="date" id="ETA" name="ETA" class="white-text" />
          <br /><br />
          <h5>Carga</h5>
          <br />
          <label for="tipo_carga">Tipo carga:</label>
          <input type="text" class="white-text" value="{{carga_tipo}}">
          <br />
          <label for="peso_neto">Peso neto:</label>
          <input type="number" id="peso_neto" name="peso_neto" class="white-text" value="{{carga_peso}}"/>
          <br />
          <label for="tipo_hazard">Tipo hazard:</label>
          <input type="text" class="white-text" value="{{carga_tipo_hazard}}">
          <br />
          <label for="temperatura_reefer">Temperatura reefer:</label>
          <input type="text" id="temperatura_reefer" name="temperatura_reefer" class="white-text" value="carga_temperatura_reefer" />
          <br /><br />
          <h5>Costeo</h5>
          <br />
          <label for="km_estimado">Km estimados:</label>
          <input value="{{costeo_km_estimados}}" type="number" id="km_estimado" name="km_estimado" class="white-text" />
          <br />
          <label for="combustible_estimado">Combustible estimado litros:</label>
          <input value="{{costeo_combustible_estimado}}" type="number" id="combustible_estimado" name="combustible_estimado" class="white-text" />
          <br />
          <label for="viaticos_estimado">Viaticos estimado:</label>
          <input value="{{costeo_viaticos_estimado}}"  type="number" id="viaticos_estimado" name="viaticos_estimado" class="white-text" />
          <br />
          <label for="peajes_estimado">Peajes estimado:</label>
          <input value="{{costeo_peajes_estimado}}" type="number" id="peajes_estimado" name="peajes_estimado" class="white-text" />
          <br />
      </form>
    </div>
    <br />
        ...
        <div class="col s12 m12">
          <div class="card black darken-1">
            ...
            <div class="card-action">
              ...
              <button class="btn waves-effect waves-light grey darken-2" type="submit" name="action">Validar<i
                  class="material-icons right">send</i></button>
              </form>
            </div>
          </div>
              ...
              <div class="card black darken-1">
                ...
                <div class="card-action">
                  <form action="/supervisor/mostrarDatosDelCelularConcretoAModificar" method="post">
                    ...
                    <button class="btn waves-effect waves-light yellow darken-2" type="submit" name="action">Modificar<i
                        class="material-icons right">send</i></button>
                  </form>
                  <br>
                  <form action="/supervisor/quitarChoferAsignado" method="post">
                    <input type="hidden" value="{{id_celular}}" name="idCelular">
                    <button class="btn waves-effect waves-light yellow darken-3" type="submit" name="action">Quitar
                  ...
                  <form method="POST" action="/supervisor/modificarCelularConcreto">
                    <div class="card-content">
                      ...
                      <div class="form-field">
                        <div class="form-field">
                          <label for="numeroCelular">Numero Celular:</label>
                          <input type="text" id="numeroCelular" name="numeroCelular" class="white-text" value="{{nro}}"
                            required>
                        </div>
                        <br>
                        <div class="card-action">
